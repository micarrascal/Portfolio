        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-white dark:bg-gray-900 rounded-2xl p-8 shadow-lg border border-gray-100 dark:border-gray-800">
            ...
            <ul className="space-y-2 text-gray-700 dark:text-gray-300">
              {(['case.tools.1', 'case.tools.2', 'case.tools.3'] as const).map((key) => (
          ...
          <div className="bg-white dark:bg-gray-900 rounded-2xl p-8 shadow-lg border border-gray-100 dark:border-gray-800">
            ...
            <ul className="space-y-2 text-gray-700 dark:text-gray-300">
              {(['case.kpis.1', 'case.kpis.2', 'case.kpis.3'] as const).map((key) => (
                <li key={key} className="flex items-start gap-2">
                  <CheckCircle className="w-5 h-5 text-pink-500 dark:text-pink-400 flex-shrink-0 mt-0.5" />
                  <span>{t(key)}</span>
                </li>
          ...
          <div className="bg-white dark:bg-gray-900 rounded-2xl p-8 shadow-lg border border-gray-100 dark:border-gray-800">
            ...
            <ul className="space-y-2 text-gray-700 dark:text-gray-300">
              {(['case.impact.1', 'case.impact.2', 'case.impact.3'] as const).map((key) => (
                <li key={key} className="flex items-start gap-2">
                  <CheckCircle className="w-5 h-5 text-pink-500 dark:text-pink-400 flex-shrink-0 mt-0.5" />
                  <span>{t(key)}</span>
                </li>
